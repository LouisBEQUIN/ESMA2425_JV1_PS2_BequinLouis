...
if (menu_x > gui_width + 150) and (menu_committed != -1)
{
	...
	{
		case 1: default : Scr_slide_transition(TRANS_MODE.NEXT); global.character_life = 5;global.credit_count = 1000;global.is_in_dungeon = false;global.first_item = false;global.dungeon_1 = false;break;
