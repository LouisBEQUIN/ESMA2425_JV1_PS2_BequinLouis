...
/// @DnDArgument : "x" "x"
/// @DnDArgument : "y" "y + 2"
/// @DnDArgument : "object" "O_drop_zone_D2"
/// @DnDSaveInfo : "object" "O_drop_zone_D2"
var l1984DCDE_0 = instance_place(x, y + 2, [O_drop_zone_D2]);if ((l1984DCDE_0 > 0)){	/// @DnDAction : YoYo Games.Common.Variable
	/// @DnDVersion : 1
	/// @DnDHash : 6D267F8F
	/// @DnDApplyTo : {O_door_tuto_close_2}
	/// @DnDParent : 1984DCDE
	/// @DnDArgument : "expr" "true"
	/// @DnDArgument : "var" "opened"
	with(O_door_tuto_close_2) {
	opened = true;
