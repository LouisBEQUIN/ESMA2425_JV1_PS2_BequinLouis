...
if instance_exists (O_character)
{
	...
	{
		draw_sprite(S_infinit_bullet_pickup_GUI, image_index, 50, 300);
	}
	...
	if (global.infinit_bullet = true)
	{
		draw_text_transformed(175,308,""+ string("???"),2,2,0);
	}
